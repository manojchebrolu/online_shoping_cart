import 'package:amazon_flutter_application/features/cart/services/card_services.dart';
...
class CardProduct extends StatefulWidget {
  final int index;
  const CardProduct({super.key, required this.index});
...
class _CardProductState extends State<CardProduct> {
  ...
  final CardServices cartServices = CardServices();
